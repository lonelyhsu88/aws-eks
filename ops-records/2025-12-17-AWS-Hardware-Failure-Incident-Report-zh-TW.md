...
**gemini-bg 不穩定節點時間軸**：
- **14:41:36**：人工容量調整（Desired: 2→3），ASG 啟動節點 **i-01b37ac4e8793faa7 (ap-east-1a)**
- **14:51:41**：節點 **i-01b37ac4e8793faa7 僅運行 10 分鐘後終止**（第三個不穩定節點！）
- **14:51:41**：👤 **運維人員主動終止不穩定節點**，將 Desired 降回 2
...
**受控容量恢復**：
- **15:11:57**：👤 確認系統穩定後**人工調整容量**（Desired: 2→3）
...
15:11:57  👤 運維人員主動增加 gemini-bg Desired: 2→3（確認穩定性後）
